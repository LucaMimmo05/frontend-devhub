...
const ProfileHoverMenu = ({ onClose }) => {
    ...
    return (
        <div className={`profile-hover-menu ${isExiting ? "exit" : ""}`}>
            <div className="menu-setting menu-settings">
                <svg
                ...
                >
                    <path
                        d={
                            ...
                            "m0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3" +
                            "m0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 " +
                            "1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22"
                        }
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
