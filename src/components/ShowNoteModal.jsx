import "../styles/shownotemodal.css";
import AddNoteModal from "./AddNoteModal";
import { useState } from "react";
const ShowNoteModal = ({ onClose, data, onSubmit, onDelete }) => {
    const [isEditing, setIsEditing] = useState(false);

    const handleEditSave = noteData => {
        onSubmit(noteData);
        setIsEditing(false);
    };
    ...
    if (isEditing) {
        return (
            <AddNoteModal onSave={handleEditSave} onClose={() => setIsEditing(false)} edit={true} initialData={data} />
        );
    }
    ...
    return (
        <div className="blur-bg">
            <div className="show-note-modal box centered">
                <div className="show-modal-content">
                    <div className="show-modal-note-title">
                        <h2>{data.title}</h2>
                ...
                <div className="show-modal-note-bottom">
                    <p>Updated on {formattedDate}</p>
                    <div className="show-modal-note-buttons">
